...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionreset_background_normal = QAction(MainWindow)
        self.actionreset_background_normal.setObjectName(u"actionreset_background_normal")
        self.actiontest_background_noise = QAction(MainWindow)
        self.actiontest_background_noise.setObjectName(u"actiontest_background_noise")
        ...
        self.menuOption.addAction(self.actionreset_background_normal)
        self.menuOption.addAction(self.actiontest_background_noise)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionreset_background_normal.setText(QCoreApplication.translate("MainWindow", u"reset background normal", None))
        self.actiontest_background_noise.setText(QCoreApplication.translate("MainWindow", u"test background noise", None))
